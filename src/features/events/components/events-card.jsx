      ...
      >
        <div className="flex justify-between items-center">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="text-[#81a9bb] hover:text-[#6c91a3] transition-colors"
        ...
        <div className="space-y-3 text-gray-600">
          <div className="flex items-center space-x-3">
            <Calendar className="w-5 h-5 text-[#81a9bb]" />
            <span>{formatEventDate(eventData.date)}</span>
          </div>
          <div className="flex items-center space-x-3">
            <Clock className="w-5 h-5 text-[#81a9bb]" />
            <span>
          ...
          <div className="flex items-center space-x-3">
            <MapPin className="w-5 h-5 text-[#81a9bb]" />
      ...
      >
        <div className="space-y-6 ">
          ...
          <div className="space-y-3">
            <CalendarButton
              icon={(props) => (
                <Chrome {...props} className="w-5 h-5 text-[#81a9bb]" />
              )}
